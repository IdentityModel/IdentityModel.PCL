...
namespace IdentityModel.Client
{
    public class OAuth2ClientOld
    {
        ...
        public OAuth2ClientOld(Uri address)
            : this(address, new HttpClientHandler())
        { }

        public OAuth2ClientOld(Uri address, HttpMessageHandler innerHttpClientHandler)
        {
        ...
        public OAuth2ClientOld(Uri address, string clientId, string clientSecret, ClientAuthenticationStyle style = ClientAuthenticationStyle.BasicAuthentication)
            : this(address, clientId, clientSecret, new HttpClientHandler(), style)
        { }

        public OAuth2ClientOld(Uri address, string clientId, string clientSecret, HttpMessageHandler innerHttpClientHandler, ClientAuthenticationStyle style = ClientAuthenticationStyle.BasicAuthentication)
